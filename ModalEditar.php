<div class="modal fade" id="editUser<?php echo $mostrar['ID']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      <form method="POST" action="_functions.php">
        ...
        <div class="modal-body" id="cont_modal">
          ...
          <div class="form-group">
            ...
            <input type="text" name="op2" class="form-control" value="<?php echo $mostrar['Deseo2']; ?>">
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Opcion 3:</label>
            <input type="text" name="op3" class="form-control" value="<?php echo $mostrar['Deseo3']; ?>">
          </div>
